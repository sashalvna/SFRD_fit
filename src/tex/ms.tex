...
Understanding the behaviour of the adopted \SFRDzZ is thus essential to explain simulation results. 
%
...
\begin{figure}
\centering
\script{TestZenodoData.py}
\includegraphics[width=0.8\textwidth]{figures/testdata.jpg}
