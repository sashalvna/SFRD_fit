...
\begin{abstract}
New observational facilities are probing astrophysical transients such as stellar explosions and gravitational wave (GW) sources at ever increasing redshifts. To interpret these observations we need to compare them to predictions from stellar population models. Such models require the metallicity-dependent cosmic star formation history (\SFRDzZ) as an input. Large uncertainties remain in the shape and evolution of this function, and understanding its behaviour is essential to explain simulation results. 
