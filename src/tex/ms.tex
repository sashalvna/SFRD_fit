...
We use the publicly available rapid binary population synthesis simulations presented in van Son et al (in prep).\footnote{Available for download at \url{https://doi.org/10.5072/zenodo.1098287},  see also the Software and Data section in the acknowledgements} 
...
The data used in this work is available on Zenodo under an open-source Creative Commons Attribution license at \dataset[doi:10.5072/zenodo.1098287]{https://doi.org/10.5072/zenodo.1098287}.
