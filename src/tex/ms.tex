...
% Downsides of TNG100 
On the other hand, large uncertainties and crude approximations remain, also in the TNG simulations. For example, dust is not included in the TNG simulations, which could mean that metallicity of the star-forming gas is overestimated. Moreover, all mass loss from massive stellar winds \citep[e.g.][]{Dray+2003}, pair-pulsational supernovae \citep[e.g.][]{Renzo+2020} and binary interactions \citep[e.g.][]{Farmer2021_carbonfootprint} are ignored. Furthermore, the ionising background is turned on abruptly at $z=6$, again not accounting for the ionising contribution from stripped stars \citep[][]{Gotberg+2020,DoughtyFinlator2021}. 
