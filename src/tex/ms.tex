...
Adopting a skewed-lognormal distribution furthermore allows for a tail of low metallicity star formation

0) the starformation rate peaks at metallicities above $10^{-2}$ for all redshifts out to at least $z=6$
most star formation happens at metallicities above $Z \gtr 10^{-2}$
