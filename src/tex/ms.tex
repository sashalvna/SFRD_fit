...
To this end we use the publicly available simulations as presented in \cite{vanson+2022}
We use the framework described in detail in \cite{vanson+2022} that is part of the \COMPAS suite to compute local merger rates of BBH systems originating from 
