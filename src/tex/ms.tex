...
%                \frac{ \left(\alpha \frac{\ln(Z) - \xi}{\omega} \right)  }{\sqrt{2}} 
    ...
    \right] \\
    %}_{(2)}.
%   &=    %%% I dont think this belongs here: \frac{1}{2} 
...
\includegraphics[width=0.8\textwidth]{figures/High_Low_metalFractionSFMass.pdf}
