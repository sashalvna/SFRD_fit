...
rate_file       = '/RateData/small_Rate_info.h5'#'small_Rate_info.h5' #'/Rate_info.h5'#
simulation_data = '/small_COMPAS_Output_wWeights.h5'#'/small_COMPAS_Output_wWeights.h5' #'/COMPAS_Output_wWeights.h5'#
